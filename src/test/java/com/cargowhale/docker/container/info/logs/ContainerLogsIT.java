...
public class ContainerLogsIT {
    ...
    public void getContainerLogs() throws Exception {
        this.dockerServiceBuilder.expectRequest("/v1.24/containers/f911b0f4e0b19e3da3bae6dcff82195/logs?follow=false&stdout=true&stderr=true&timestamps=false&since=0&tail=100", HttpMethod.GET, HttpStatus.OK, MediaType.TEXT_PLAIN);
